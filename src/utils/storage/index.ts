...
export const saveCustomerToken = async (customerToken?: string | null) =>
  saveValue(AsyncStorageKeys.CustomerAccessToken, customerToken);
...
export const saveRefreshToken = (refreshToken?: string | null) =>
  saveValue(AsyncStorageKeys.CustomerRefreshToken, refreshToken);

export const loadRefreshToken = async () =>
  loadValue(AsyncStorageKeys.CustomerRefreshToken);

export const removeRefreshToken = async () =>
  removeValue(AsyncStorageKeys.CustomerRefreshToken);

export const saveExpiresIn = async (time?: string | null) =>
  saveValue(AsyncStorageKeys.CustomerExpiresIn, time);
